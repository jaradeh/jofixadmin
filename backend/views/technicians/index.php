...
/* @var $searchModel backend\models\TechniciansSearch */
...
//                                        'id',
                                        ...
                                        [
                                            ...
                                            'value' => function ($model) {
                                                if ($model->image != NULL) {
                                                    return "<img src='/backend/web/media/technicians/original/" . $model->image . "' style='width:200px;'>";
                                                } else {
                                                    return "<center><img src='/backend/web/img/dummy/u13.png' style='width:100px;'></center>";
                                                }
                                            },
                                        ],
                                        [
